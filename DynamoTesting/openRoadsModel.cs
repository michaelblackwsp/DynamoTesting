namespace DynamoTesting
{
    public class openRoadsModel
    {
        ...
        public static string[] clientOptions = { "MTO v2022", "MTQ v2021", "MTQ v2022_CIV", "WSP_EN v2022", "<Standard>" };
        ...
        public Dictionary<string, string[]> versionsBasedOnClient = new Dictionary<string, string[]>
        {
            ...
            { "MTQ v2022_CIV", new string[] { "2022 R1", "2022 R3" } },
        ...
        public Dictionary<string, string[]> clientsBasedOnVersion = new Dictionary<string, string[]>
        {
            ...
            { "2022 R1", new string[] { "MTO v2022", "MTQ v2021", "MTQ v2022_CIV", "<Standard>" } },
            { "2022 R3", new string[] { "MTO v2022", "MTQ v2022_CIV", "WSP_EN v2022", "<Standard>" } },
        };
        #endregion
        ...
        {
            { "10.09.00.091", "2020 Release 3" }, // 2020 R3
            { "10.10.21.004", "2021 Release 2" }, // 2021 R2
            { "10.11.00.115", "2022 Release 1" }, // 2022 R1
            { "10.12.02.004", "2022 Release 3" }, // 2022 R3
        };
        ...
        public string BuildOpenRoadsStandardShortcut(string client, string version)
        {
            ...
            if (version != "2020 R3")
            {
                ...
                shortcut = "C:\\Program Files\\Bentley\\" + installationFolder + "\\OpenRoadsDesigner\\OpenRoadsDesigner.exe";
            }
            else
            {
                shortcut = "C:\\Program Files\\Bentley\\OpenRoads Designer CONNECT Edition\\OpenRoadsDesigner\\OpenRoadsDesigner.exe";
            }
        ...
        {
            { "2020 R3", "OpenRoads Designer CE 10.09" },
        ...
        public string BuildOpenRoadsEnvironmentShortcut(string client, string version)
        {
            ...
            string clientWithoutLetterVandAfter = clientNoSpaces.Substring(0, indexOfV-1);
